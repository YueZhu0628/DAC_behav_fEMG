...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-likert-statement { display:block; font-size: 25px; padding-top: 40px; margin-bottom:10px;}"+
      ".jspsych-survey-likert-opts { list-style:none; width:"+w+"; margin:auto; padding:0 0 35px; display:block; font-size: 18px; line-height:1.1em; }"+
